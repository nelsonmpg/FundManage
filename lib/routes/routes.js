...
//Wallet of Funds
router.post("/api/walletfunds", middleware.isLoginCheck, (req, res) => { walletLib.saveWallet(req, res); });
router.get("/api/walletfunds/:owner", middleware.isLoginCheck, (req, res) => { walletLib.getOwnerWallets(req, res); });
router.get("/api/walletfunds/:owner/:wallet", middleware.isLoginCheck, (req, res) => { walletLib.getOwnerWalletFundList(req, res); });
