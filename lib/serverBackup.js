...
var express = require('express'),
    ...
    walletslib = require('./libwallet.js');
let readmePathA = require.resolve('./libFunds.js');
let readmePathB = require.resolve('./libwallet.js');
...
var ServerUpdate = function (config) {
    ...
    let self = this;
    console.log(readmePathA, readmePathB);
