...
let self = module.exports = {
  ...
  insertFunds: function () {
    let arrFunds = [
      ...
      { isin: "PTYSADLM0008", name: "Santander Acções Europa" },
      { isin: "PTYMCBLM0004", name: "Santander Acções América" }/* ,
      { isin: "PTYSAIHE0017", name: "Santander Select Defensivo" },
      { isin: "PTYSBZHM0007", name: "Santander Rendimento" } */
    ]
  ...
  insertWallets: function () {
    let wallets = [{
      owner: '5cc482d118c1000865a2840d',
      ...
      owner: '5cc482d118c1000865a2840d',
      nameWallet: 'My Wallet TT',
      listFunds: [{
        isin: "PTYSADLM0008",
        name: "Santander Acções Europa",
        investList: [{
          dateInvest: "2019-04-22",
          dateCheck: new Date("2019-04-22").getTime(),
          nUps: 100.240577
        }]
      }, {
        isin: "PTYMCBLM0004",
        name: "Santander Acções América",
        investList: [{
          dateInvest: "2019-04-22",
          dateCheck: new Date("2019-04-22").getTime(),
          nUps: 114.827701
