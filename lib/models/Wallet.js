...
Wallet.prototype.updateCotacao = function (res, fund, pos, callback) {
  console.log("Teste val", pos, fund.Value, fund.isin, fund.name, fund.dateInvest, new Date(fund.dateInvest).getTime());
  ...
  this.walletdb.updateOne({
    ...
    "listFunds.investList.dateCheck": fund.dateInvest // new Date(fund.dateInvest).getTime()
  }, {
      "$set": {
