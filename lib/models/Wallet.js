...
Wallet.prototype.updateCotacao = function (res, fund, pos, callback) {
  console.log("Save fund Wallet", pos, fund.Value, fund.isin, fund.dateInvest, fund.HistoryDetail.length, fund.HistoryDetail[0], fund.HistoryDetail[fund.HistoryDetail.length - 1]);
  let options = {
    upsert: true
  };
