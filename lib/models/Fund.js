...
Fund.prototype.getFundCotacaoByDateAndCalcMoney = function (res, ownerRec, isinCode, nUps, dateCota, dateEnd, callback) {
  console.log("func receive", ownerRec, isinCode, nUps, dateCota, dateEnd);
