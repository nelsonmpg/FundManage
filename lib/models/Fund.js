...
Fund.prototype.getFundCotacaoByDateAndCalcMoney = function (res, ownerRec, isinCodeRec, nUpsRec, dateCota, dateEnd, callback) {
  console.log("func receive", ownerRec, isinCodeRec, nUpsRec, dateCota, dateEnd);

  let self = this,
    owner = ownerRec,
    isinCode = isinCodeRec,
    nUps = nUpsRec.
      query = [
        {
          $match: { isin: isinCode }
